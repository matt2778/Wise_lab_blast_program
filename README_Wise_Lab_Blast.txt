README file for 2-6-2017_lab_blast_program_v1.sh script
...
1.	Logging into speedy server
	...
	The script 2-6-2017_lab_blast_program_v1.sh is run from a the terminal program accessed on Mac or linux computers.  Open up a terminal and log into the speedy server:
...
2.	A txt file that contains the traditional web blast output 
	...
	Please be aware of the size of the txt file, as larger searches can result in VERY large files (>1 Gb) and may be too large to open directly on a computer
